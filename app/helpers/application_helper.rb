module ApplicationHelper
  ...
  ADVANCED_SIDEBAR_LIBRARY_DEFS = [
    ...
    { key: "ports", label: "Ports", icon: "fa-solid fa-anchor", color: "#8bc34a", target: "qlPorts", meta: "Trade and cargo hubs." },
    { key: "shippingLanes", label: "Shipping Lanes", icon: "fa-solid fa-route", color: "#ff8a00", target: "qlShippingLanes", meta: "Returns after cleanup.", disabled: true },
    { key: "trains", label: "Live Trains", icon: "fa-solid fa-train-subway", color: "#e53935", target: "qlTrains", meta: "Returns after cleanup.", disabled: true },
    ...
    { key: "airbases", label: "Airbases", icon: "fa-solid fa-tower-observation", color: "#ff7043", target: "qlAirbases", meta: "Military airfields.", tag: "MIL" },
    ...
    { key: "navalVessels", label: "Naval Vessels", icon: "fa-solid fa-ship", color: "#42a5f5", target: "qlNavalVessels", meta: "Military and state vessels from AIS.", tag: "MIL" },
    ...
    { key: "airports", label: "Airports", icon: "fa-solid fa-tower-broadcast", color: "#81c784", target: "qlAirports", meta: "Civilian airport catalog." },

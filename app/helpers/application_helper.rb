module ApplicationHelper
  ...
  ADVANCED_SIDEBAR_LIBRARY_DEFS = [
    { key: "flights", label: "Flights", icon: "fa-solid fa-plane", color: "#4fc3f7", target: "qlFlights", meta: "Civilian and commercial air traffic. Pair with Military Flights for defense-only activity." },
    { key: "ships", label: "Ships", icon: "fa-solid fa-ship", color: "#26c6da", target: "qlShips", meta: "Civilian AIS traffic. Pair with Naval Vessels for military and state traffic." },
    ...
    { key: "fireHotspots", label: "Fire Hotspots", icon: "fa-solid fa-fire", color: "#ff5722", target: "qlFireHotspots", meta: "Raw global FIRMS detections. Separate from conflict-focused Heat Signatures." },
    ...
    { key: "ports", label: "Ports", icon: "fa-solid fa-anchor", color: "#8bc34a", target: "qlPorts", meta: "Trade ports and cargo hubs." },
    { key: "shippingLanes", label: "Shipping Lanes", icon: "fa-solid fa-route", color: "#ff8a00", target: "qlShippingLanes", meta: "Temporarily unavailable during cleanup.", disabled: true },
    { key: "trains", label: "Live Trains", icon: "fa-solid fa-train-subway", color: "#e53935", target: "qlTrains", meta: "Temporarily unavailable during cleanup.", disabled: true },
    { key: "notams", label: "NOTAMs / TFRs", icon: "fa-solid fa-ban", color: "#ef5350", target: "qlNotams" },
    { key: "militaryFlights", label: "Military Flights", icon: "fa-solid fa-jet-fighter", color: "#ef5350", target: "qlMilitaryFlights", meta: "Separate military-only air picture.", tag: "MIL" },
    { key: "airbases", label: "Airbases", icon: "fa-solid fa-tower-observation", color: "#ff7043", target: "qlAirbases", meta: "Military airfields from the airport catalog.", tag: "MIL" },
    { key: "militaryBases", label: "Military Bases", icon: "fa-solid fa-shield-halved", color: "#ff5252", target: "qlMilitaryBases", meta: "Curated defense installations.", tag: "MIL" },
    { key: "navalVessels", label: "Naval Vessels", icon: "fa-solid fa-ship", color: "#42a5f5", target: "qlNavalVessels", meta: "Military and state vessels derived from AIS.", tag: "MIL" },
    { key: "verifiedStrikes", label: "Verified Strikes", icon: "fa-solid fa-crosshairs", color: "#4caf50", target: "qlVerifiedStrikes", meta: "GeoConfirmed-backed strike reports." },
    { key: "heatSignatures", label: "Heat Signatures", icon: "fa-solid fa-fire-flame-curved", color: "#e040fb", target: "qlHeatSignatures", meta: "Conflict-focused FIRMS thermal detections." },
    ...
    { key: "railways", label: "Railways", icon: "fa-solid fa-train", color: "#90a4ae", target: "qlRailways", meta: "Temporarily unavailable during cleanup.", disabled: true },
    ...
    { key: "airports", label: "Airports", icon: "fa-solid fa-tower-broadcast", color: "#81c784", target: "qlAirports", meta: "Civilian airport catalog. Pair with Airbases for military airfields." },

const BASE_LAYER_REGISTRY = [
  ...
  { key: "situationSurfaces", toggleTarget: "situationSurfacesToggle", method: "toggleSituationSurfaces", visibleProp: "situationSurfacesVisible", qlTarget: "qlSituationSurfaces", section: "events", pill: { label: "SURF", color: "#d32f2f" } },
  ...
  { key: "commoditySites", toggleTarget: "commoditySitesToggle", method: "toggleCommoditySites", visibleProp: "commoditySitesVisible", qlTarget: "qlCommoditySites", section: "infrastructure", pill: { label: "SITE", color: "#9ccc65" } },

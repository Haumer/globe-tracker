...
export const REGIONS = [
  // ── Indo-Pacific ──
  {
    ...
    layers: ["flights", "ships", "cables", "gpsJamming", "conflicts", "news", "chokepoints"],
  ...
  },
  {
    ...
    layers: ["flights", "ships", "cables", "gpsJamming", "conflicts", "news"],
    satCategories: ["military"],
  ...
  // ── Middle East ──
  {
    ...
    layers: ["ships", "flights", "chokepoints", "conflicts", "news", "pipelines", "gpsJamming"],
    satCategories: ["military"],
  ...
  },
  {
    ...
    layers: ["ships", "flights", "chokepoints", "conflicts", "news", "cables", "gpsJamming"],
    satCategories: ["military"],
  ...
  },
  {
    ...
    layers: ["flights", "ships", "pipelines", "conflicts", "news", "gpsJamming", "chokepoints"],
    satCategories: ["military"],
  ...
  // ── Europe ──
  {
    ...
    layers: ["ships", "flights", "cables", "pipelines", "gpsJamming", "news", "notams"],
    satCategories: ["military"],
  ...
  },
  {
    ...
    layers: ["ships", "flights", "conflicts", "news", "gpsJamming", "cables"],
    satCategories: ["military"],
  ...
  },
  {
    ...
    layers: ["conflicts", "ships", "news", "flights", "chokepoints"],
  ...
  // ── Maritime / Strategic ──
  {
    ...
    layers: ["ships", "chokepoints", "cables", "news"],
  ...
  },
  {
    ...
    layers: ["ships", "flights", "cables", "weather", "news"],
    satCategories: ["military"],
  ...
  // ── Americas ──
  {
    ...
    layers: ["ships", "flights", "weather", "news", "cables"],

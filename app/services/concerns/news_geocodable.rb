module NewsGeocodable
  ...
  CITY_COORDS = {
    ...
    # --- Major Airports (precise coordinates for headline geocoding) ---
    "laguardia" => [40.777, -73.873], "la guardia" => [40.777, -73.873],
    "jfk airport" => [40.641, -73.778], "jfk" => [40.641, -73.778],
    "newark airport" => [40.693, -74.169],
    "heathrow" => [51.471, -0.460], "gatwick" => [51.148, -0.190],
    "stansted" => [51.885, 0.235], "luton airport" => [51.875, -0.368],
    "charles de gaulle" => [49.010, 2.548], "cdg" => [49.010, 2.548],
    "orly" => [48.726, 2.365],
    "schiphol" => [52.309, 4.764],
    "frankfurt airport" => [50.033, 8.571],
    "munich airport" => [48.354, 11.786],
    "dubai airport" => [25.253, 55.366],
    "changi airport" => [1.350, 103.994],
    "haneda" => [35.553, 139.780], "narita" => [35.765, 140.386],
    "incheon airport" => [37.469, 126.451],
    "ben gurion" => [32.011, 34.887],
    "ataturk airport" => [40.977, 28.821], "istanbul airport" => [41.261, 28.742],
    "o'hare" => [41.978, -87.904], "ohare" => [41.978, -87.904],
    "lax" => [33.943, -118.408],
    "dulles" => [38.944, -77.456], "reagan airport" => [38.851, -77.040],
    "pearson airport" => [43.677, -79.631],
    "logan airport" => [42.366, -71.010],
    "denver airport" => [39.856, -104.674],
    "atlanta airport" => [33.637, -84.428], "hartsfield" => [33.637, -84.428],
    "miami airport" => [25.796, -80.287],
    "tehran airport" => [35.689, 51.311], "imam khomeini airport" => [35.416, 51.152],
    "isfahan airport" => [32.751, 51.862],
    "damascus airport" => [33.411, 36.516],

...
class Api::ShippingLanesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "GET /api/shipping_lanes returns derived shipping lanes" do
  ...
  test "GET /api/shipping_lanes returns the baseline corridor network without supply chain rows" do
    get "/api/shipping_lanes"
    assert_response :success
